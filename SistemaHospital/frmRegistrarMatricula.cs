...
using static SistemaHospital.Reutilizable.EnumModelo;
...
namespace SistemaHospital
{
    public partial class frmRegistrarMatricula : Form
    {
        ...
        public int PidArea;
        public int PidHabitacion;
        public string PdescripcionArea;
        public string PdescripcionHabitacion;
        ...
        private void frmRegistrarMatricula_Load(object sender, EventArgs e)
        {
            ...
            txtidalumno.Text = "0";
            txtnivelacademico.Text = PdescripcionArea;
            txtgradoseccion.Text = PdescripcionHabitacion;
            ...
            cbotiporelacion_apo.Items.Add(new ComboBoxItem() { Value = "ARS", Text = "ARS" });
            cbotiporelacion_apo.Items.Add(new ComboBoxItem() { Value = "Humano", Text = "Humano" });
            cbotiporelacion_apo.Items.Add(new ComboBoxItem() { Value = "Universal", Text = "Universal" });
            cbotiporelacion_apo.Items.Add(new ComboBoxItem() { Value = "SENASA", Text = "SENASA" });
            cbotiporelacion_apo.Items.Add(new ComboBoxItem() { Value = "Mapfre", Text = "Mapfre" });
            cbotiporelacion_apo.Items.Add(new ComboBoxItem() { Value = "ARSPALIC", Text = "ARSPALIC" });
            cbotiporelacion_apo.DisplayMember = "Text";
            cbotiporelacion_apo.ValueMember = "Value";
            cbotiporelacion_apo.SelectedIndex = 0;

            cboestadocivil_apo.Items.Add(new ComboBoxItem() { Value = "Titular", Text = "Titular" });
            cboestadocivil_apo.Items.Add(new ComboBoxItem() { Value = "Referido", Text = "Referido" });
            cboestadocivil_apo.Items.Add(new ComboBoxItem() { Value = "Pariente", Text = "Pariente" });
        ...
        private void btnbuscar_Click(object sender, EventArgs e)
        {
            ...
            if (oObjecto != null)
            {
                Paciente oAlumno = (Paciente)oObjecto;
                if (oAlumno != null)
                {
                    txtidalumno.Text = oAlumno.IdPaciente.ToString();
                    ...
                    txtciudad_alu.Text = oAlumno.Deuda.ToString();
        ...
        private void btnregistrar_Click(object sender, EventArgs e)
        {
            ...
            xml.Add(new XElement("ACADEMICO",
                        ...
                        new XElement("idnivel", PidArea),
                        new XElement("idgradoseccion", PidHabitacion),
            ...
            xml.Add(new XElement("ALUMNO",
                        ...
                        new XElement("deuda", txtciudad_alu.Text ),
            ...
            int Respuesta = CD_GenerarReporte.Registrar(xml.ToString());
